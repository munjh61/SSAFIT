...
('user01', '스키 처음 탄 날', '처음 타보는 스키! 넘어졌지만 즐거웠던 하루', '운동,겨울스포츠'),
('user01', '버킷리스트: 마라톤 완주', '인생 첫 마라톤 완주! 도전하길 잘했다는 생각이 드네요.', '운동,마라톤'),
...
VALUES 
(1, 'user01', 1, '2025-05-20 14:30:00'),
(2, 'user01', 1, '2024-01-01 12:00:00'),                            -- 그냥 좋아요
